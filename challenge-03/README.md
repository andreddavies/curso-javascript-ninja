...
*/
pessoa.nomeCompleto(); // Olá! Meu nome é André Davies!
...
// Agora, apresente-se ;)
pessoa.apresentacao(); // Olá, eu sou o André Davies, tenho 22 anos, 1.75, meu peso é 78 e, só hoje, eu já caminhei 10 metros!
```
